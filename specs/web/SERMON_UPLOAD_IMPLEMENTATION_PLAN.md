...
| **`apps/web`** | [`UploadModal.tsx`](apps/web/src/components/shared/upload/UploadModal.tsx) overlay or [`UploadProgressStep.tsx`](apps/web/src/components/shared/upload/UploadProgressStep.tsx) / shared **banner** component — confirm in Figma whether this is _processing_, _blocking_, or _handoff_ |
