    ...
    const fetchDrafts = useCallback(async () => {
        ...
        try {
            ...
            if (import.meta.env.DEV) {
                ...
                if (devDrafts.length) {
                    console.warn(
                        'Drafts API unavailable; showing dev upload drafts only.',
                        error,
                    );
                }
                return;
        ...
        async (draft: Partial<IDraft>): Promise<IDraft> => {
            ...
            try {
                ...
                if (typeof sermonApi.saveDraft !== 'function') {
                    throw new Error(
                        'saveDraft is not implemented on sermon API',
                    );
                }
                const payload = {
                    title: draft.title,
        ...
        async (draftId: string, draft: Partial<IDraft>): Promise<IDraft> => {
            ...
            try {
                ...
                if (typeof sermonApi.updateDraft !== 'function') {
                    throw new Error(
                        'updateDraft is not implemented on sermon API',
                    );
                }
                const payload = {
                    title: draft.title,
        ...
        async (draftId: string) => {
            ...
            try {
                ...
                if (typeof sermonApi.deleteDraft !== 'function') {
                    throw new Error(
                        'deleteDraft is not implemented on sermon API',
                    );
                }
...
export const draftActions = {
    setDrafts: (payload: IDraft[]) => ({
        type: 'SET_DRAFTS' as const,
        payload,
    }),
    ...
    updateDraft: (payload: IDraft) => ({
        type: 'UPDATE_DRAFT' as const,
        payload,
    }),
    deleteDraft: (payload: string) => ({
        type: 'DELETE_DRAFT' as const,
        payload,
    }),
