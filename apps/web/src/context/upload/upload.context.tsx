    ...
    switch (action.type) {
        ...
        case 'SET_FILE':
            return {
                ...
                backgroundUploadId: action.payload
                    ? null
                    : state.backgroundUploadId,
            };
...
export const uploadActions = {
    ...
    setFile: (file: File | null) => ({
        type: 'SET_FILE' as const,
        payload: file,
    }),
    setUploadData: (data: Partial<ISermonUpload>) => ({
        type: 'SET_UPLOAD_DATA' as const,
        payload: data,
    }),
    ...
    setUploadComplete: (complete: boolean) => ({
        type: 'SET_UPLOAD_COMPLETE' as const,
        payload: complete,
    }),
    setActiveOption: (option: string) => ({
        type: 'SET_ACTIVE_OPTION' as const,
        payload: option,
    }),
    setBackgroundUploadId: (id: string | null) => ({
        type: 'SET_BACKGROUND_UPLOAD_ID' as const,
        payload: id,
    }),
    resetUpload: () => ({ type: 'RESET_UPLOAD' as const }),
    loadFromStorage: (data: Partial<ISermonUpload>) => ({
        type: 'LOAD_FROM_STORAGE' as const,
        payload: data,
    }),
    loadFromDraft: (data: Partial<ISermonUpload>) => ({
        type: 'LOAD_FROM_DRAFT' as const,
        payload: data,
    }),
