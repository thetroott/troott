      ...
      <table className="w-full">
        ...
        >
          <tr className="border-b border-border/30">
            ...
            <th className="text-right py-3 px-4 w-48"></th>
          </tr>
        </thead>
        <tbody>
            ...
            >
              ...
              <td className="py-3 px-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-medium text-foreground">{sermon.title}</div>
                    <div className="text-sm text-muted-foreground">{sermon.duration}</div>
                  </div>
                </div>
              </td>
