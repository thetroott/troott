...
const VerifyDocument1 = () => {
  ...
  const documentType = localStorage.getItem('selectedDocumentType') || 'driver-license';
  ...
  const handleFileUpload = (frontFile: File, backFile: File) => {
    console.log('Files uploaded:', { frontFile: frontFile.name, backFile: backFile.name });
  ...
  return (
    <>
      ...
      <FileUploadDialog
        ...
        config={{
          title: documentType === "passport" ? "International Passport Verification" : "Driver License Verification",
          description: documentType === "passport" 
          ...
          onSubmit: (files) => {
            if (documentType === "passport") {
              ...
              if (passportFile) {
                console.log('International passport uploaded:', passportFile.name);
                ...
                localStorage.setItem('internationalPassportDocuments', JSON.stringify(fileData));
              }
            } else {
