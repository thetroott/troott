...
const internationalPassportConfig: UploadConfig = {
  ...
  description: "International Passport Verification<br/>Make sure that photo page of your international passport is clear and shows your <br/> personal details, photo, and passport number.",
  fields: [
    {
