...
const FileUploadContent = ({ 
  ...
  const handleSubmit = async () => {
    const validFiles = Object.entries(files).reduce((acc, [key, file]) => {
  ...
  return (
    <>
      <div className="space-y-6 py-4 text-left">
        ...
        <div className="pt-4">
          <div className={`grid gap-4 ${config.fields.length === 1 ? 'grid-cols-1' : 'grid-cols-2'} text-left`}>
                  ...
                  <div className="border border-dashed border-gray-300 rounded-lg p-4 hover:border-gray-400 transition-colors">
                    ...
                    {file ? (
                      ...
                      >
                        ...
                        <span className="text-sm text-gray-600">{field.uploadText}</span>
