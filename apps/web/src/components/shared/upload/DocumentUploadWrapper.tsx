...
const DocumentUploadWrapper = ({ initialDocumentType }: { initialDocumentType?: DocumentType }) => {
      ...
      <div className="w-full">
        <div className="mb-4 flex items-center justify-between">
          ...
          <div className="text-sm text-muted-foreground">
            Uploading: {documentOptions.find(opt => opt.type === documentType)?.label}
          </div>
        </div>
  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-7">
      <div className="text-center mb-8">
        ...
        <p className="text-muted-foreground">Choose the type of document you want to upload</p>
      </div>
