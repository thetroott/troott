...
const useFormValidation = (initialValues: Record<string, any>) => {
  ...
  const { validateName, validateEmail, validatePassword } = usePasswordUtils();
  ...
  const validateNameField = useCallback((name: string, value: string, fieldName: string) => {
  ...
  const validateEmailField = useCallback((name: string, value: string) => {
