            ...
            <View style={styles.backdrop}>
                <View style={styles.card}>
                    ...
                    <Text style={styles.subtitle}>
                        Reanimated / Worklets need JS on the in-app Hermes
                        runtime (not Chrome as the JS engine). On New
                        Architecture, the React Native dev menu may say
                        Bridgeless; that is normal. Worklets also use a separate
                        UI runtime—see Software Mansion’s “Runtime kinds”
                        overview for the model.
                    </Text>
                    <ScrollView
                        style={styles.scroll}
                    ...
                    >
                        <Text style={styles.step}>
                            1. Open the dev menu (shake device, or Cmd+D /
                            Ctrl+M on simulator).
                        </Text>
                        <Text style={styles.step}>
                            2. On the Expo menu, &quot;Open JS debugger&quot; is
                            OK—it attaches DevTools to Hermes in the app. If you
                            opened &quot;Open React Native dev menu&quot; from
                            the bottom, turn OFF &quot;Remote JS Debugging&quot;
                            / &quot;Debug with Chrome&quot; there (that mode
                            runs JS in Chrome and breaks Worklets).
                        </Text>
                        <Text style={styles.step}>
                            3. Force-quit this app (swipe away from the app
                            switcher), then reopen it.
                        </Text>
                        <Text style={styles.step}>
                            4. Close any Chrome tab from legacy &quot;Debug JS
                            Remotely&quot; where Chrome was the JS engine.
                            Prefer Expo &quot;Open JS debugger&quot; or press j
                            in the Metro terminal.
                        </Text>
                        <Text style={styles.step}>
                            5. If it still shows: stop Metro, then from the repo
                            root run pnpm start:mobile:clear (or pnpm --filter
                            @troott/mobile run start:clear), then launch the dev
                            client again.
                        </Text>
