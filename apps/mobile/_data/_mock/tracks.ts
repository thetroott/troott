...
export const tracks: Partial<ISermonTrack>[] = [
  ...
  {
    id: "004",
    sermon: require("@/assets/audio/how_to_ask_god_for_anything_in_prayer_apostle_joshua_selman_apostlejoshuaselman_motivation_pray_aac_58818.mp4"),
  ...
  {
    id: "008",
    sermon: require("@/assets/audio/it_doesn_39_t_matter_what_you_are_going_through_motivational_pastor_chris_aac_58743.mp4"),
  ...
  {
    id: "009",
    sermon: require("@/assets/audio/life_is_short_live_every_day_for_god_billy_graham_inspirational_amp_motivational_video_aac_58991.mp4"),
