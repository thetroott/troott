    ...
    devtools(
        persist(
            (set): PlayerQueueStore => ({
                ...
                setLastPlayed: (lastPlayed: LastPlayedSummary | undefined) =>
                    set({ lastPlayed }),
            }),
            {
...
export const useCurrentTrack = () =>
    usePlayerQueueStore((state) => state.currentTrack);

export const useCurrentIndex = () =>
    usePlayerQueueStore((state) => state.currentIndex);

export const useRepeatModeStoreValue = () =>
    usePlayerQueueStore((state) => state.repeatMode);

export const useLastPlayed = () =>
    usePlayerQueueStore((state) => state.lastPlayed);
