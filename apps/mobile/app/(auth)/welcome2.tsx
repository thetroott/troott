...
export default function IndexScreen() {
  ...
  // #region agent log
  React.useEffect(() => {
    fetch("http://127.0.0.1:7249/ingest/c1282b9f-cd10-4319-9a20-a2bebd074195", {
      method: "POST",
      headers: { "Content-Type": "application/json", "X-Debug-Session-Id": "2680e1" },
      body: JSON.stringify({
        sessionId: "2680e1",
        runId: "index",
        hypothesisId: "B",
        location: "index.tsx:IndexScreen",
        message: "IndexScreen mounted, classNames passed to View/Button",
        data: {
          rootViewClassName: ROOT_VIEW_CLASS,
          firstButtonClassName: FIRST_BUTTON_CLASS,
        },
        timestamp: Date.now(),
      }),
    }).catch(() => {});
        ...
        <VStack className="w-full max-w-[343px] items-center" gap="8">
          ...
          <VStack className="w-full" gap="4">
            ...
            <Button
              variant="outline"
              size="default"
              className="min-h-12 h-12 w-full items-center justify-center"
              containerStyle={{ borderRadius: 4 }}
