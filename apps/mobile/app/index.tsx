      ...
      <View style={[customStyles.welcomeScreenContainer, {}]}>
        <ScrollView>
          <View style={customStyles.welcomeScreenView}>
            <Image source={IMAGES.ministersGroup} style={{ width: theme.sizes.screen.width, height: theme.sizes.screen.height * 0.6 }} />
            <CustomImage
              source={IMAGES.png}
          ...
          <View style={[customStyles.mt30, { paddingHorizontal: 10, gap: 20 }]}>
            <Button onPress={handleCreateAccount} disabled={isCreatingAccount} isLoading={isCreatingAccount} label="Create Account" />
