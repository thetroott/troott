            ...
            >
                <FlashList
                    ...
                    renderItem={({ item }) => (
                        <CategoryItem
                            ...
                            id={item.id}
                            onPress={() =>
                                setSelectedCategory(item.name as categoryKey)
                            }
                ...
                >
                    ...
                    >
                        ...
                        {displayStyle === 'grid' && (
                            <Grid1 color={theme.colors.white[50]} />
                        )}
                    </Pressable>
                </View>
...
function ListeningHistory({ displayStyle = 'list' }: ListeningHistoryProps) {
    const listeningItems: SermonItemDTO[] = useMemo(
        () =>
