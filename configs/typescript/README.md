...
```json
{
    "extends": "@troott/configs-typescript/base"
}
```
...
```json
{
    "extends": "@troott/configs-typescript/nextjs"
}
```
...
```json
{
    "extends": "@troott/configs-typescript/react-library"
}
```
