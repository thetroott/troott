...
```js
import { baseConfig } from '@troott/configs/eslint/base';
import { nextConfig } from '@troott/configs/eslint/next';
...
```js
import { baseConfig } from '@troott/configs/eslint/base';
import { reactInternalConfig } from '@troott/configs/eslint/react-internal';
